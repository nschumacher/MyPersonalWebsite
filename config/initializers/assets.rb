...
Rails.application.config.assets.precompile += %w( sir_nicholas_blank.png )
Rails.application.config.assets.precompile += %w( home_icon.png )
Rails.application.config.assets.precompile += %w( person_icon.png )
Rails.application.config.assets.precompile += %w( resume_icon.png )
Rails.application.config.assets.precompile += %w( dev_board_icon.png )
...
Rails.application.config.assets.precompile += %w( hawaii.jpg )
